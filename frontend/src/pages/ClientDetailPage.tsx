  ...
  return (
    <section>
      ...
      <p className="text-xs text-slate-500">
        Site and contact counts are live. Audit, finding, CAPA, certificate, document, and outstanding invoice counts
        come from persisted rows. Complaint and appeal counts stay at zero until those modules persist data.
      </p>
